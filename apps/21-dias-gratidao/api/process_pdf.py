#!/usr/bin/env python3
"""Processa o PDF do 21 Dias de Gratidão e indexa no Supabase.

Gera:
- 1 row em `ebooks` com slug=21-dias-gratidao
- N rows em `ebook_pages` com texto + embedding BGE-small-en
- 1 capa extraída (PyMuPDF) e salva no Storage
"""
...
BOOK_TITLE = '21 Días para Desarrollar la Gratitud'
BOOK_AUTHOR = 'Octavio Déniz'
...
def main():
    ...
    if existing:
        ...
        rows = supabase('POST', '/rest/v1/ebooks', body={
            ...
            'description': '21 días de ejercicios para desarrollar el hábito de la gratitud.',
    ...
    cover_path = '/tmp/gratidao-cover.jpg'
    try:
        import sys
